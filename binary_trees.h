...
const binary_tree_t *second);
void ptlo_helper(const binary_tree_t *tree, void (*func)(int), size_t level);
int ptic_helper(const binary_tree_t *tree, size_t index, size_t size);
int ptib_helper(const binary_tree_t *tree, int low, int hi);
bst_t *bst_min_val(bst_t *root);
int ptia_helper(const binary_tree_t *tree, int low, int hi);
